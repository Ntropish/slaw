...
function envIsNode(argv) {
  ...
  function readBinary(filename) {
    var ret = shell_read(filename, true)
    if (!ret.buffer) {
      ret = new Uint8Array(ret)
    }
    if (!ret.buffer) throw Error('No buffer in ret')
    return ret
  }
  function load(f) {
    globalEval(read(f))
  ...
  return {
    ...
    load: load,
    inspect: () => '[Emscripten Module object]',
  }
}

function EnvIsWebOrWorker(envIsWorker) {
...
var ERRNO_CODES = require('./ErrorCodes')
...
var ERRNO_MESSAGES = require('./ErrorMessages')
var PATH = {
...
var __GLOBAL__sub_I_juce_core_cpp = (Module['__GLOBAL__sub_I_juce_core_cpp'] =
  asm['__GLOBAL__sub_I_juce_core_cpp'])
...
var __GLOBAL__sub_I_juce_events_cc = (Module['__GLOBAL__sub_I_juce_events_cc'] =
  asm['__GLOBAL__sub_I_juce_events_cc'])
...
var __GLOBAL__sub_I_juce_audio_cc = (Module['__GLOBAL__sub_I_juce_audio_cc'] =
  asm['__GLOBAL__sub_I_juce_audio_cc'])
